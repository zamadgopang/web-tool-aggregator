...
export function ToolSeoContent({ tool }: ToolSeoContentProps) {
    ...
    return (
        <section className="mt-8 sm:mt-12 mb-12 sm:mb-16 max-w-4xl mx-auto px-3 sm:px-4 space-y-8 sm:space-y-12" aria-label={`About ${tool.title}`}>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 p-4 sm:p-6 rounded-xl bg-muted/30 border border-border">
                ...
                <div>
                    ...
                    <ol className="space-y-2 sm:space-y-3">
                        {seoContent.howItWorks.map((step, index) => (
                            <li key={index} className="flex items-start gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-lg bg-muted/20 border border-border">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg bg-muted/20 border border-border">
