  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Developer tools include JSON Formatter, Regex Tester, JWT Decoder, JSON to TypeScript converter, YAML/JSON converter, Cron Parser, SQL Formatter, HTML Entity Encoder, Meta Tag Generator, Chmod Calculator, and SEO & Performance Auditor.",
        },
      },
    ],
  }
